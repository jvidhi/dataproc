...
# e.g. ./build-container-image.sh 2.0.0 gs://spark-lib/bigquery/spark-bigquery-with-dependencies_2.12-0.22.2.jar us-central1
#........................................................................
...
DOCKER_IMAGE_FQN="docker.pkg.dev/$PROJECT_ID/s8s-spark/$DOCKER_IMAGE_NM:$DOCKER_IMAGE_TAG"
...
RUN ${CONDA_HOME}/bin/conda install mamba -n base -c conda-forge \
    && ${CONDA_HOME}/bin/mamba install -c conda-forge \
      conda \
      fastavro \
      fastparquet \
      gcsfs \
...
# Build image
docker build . --progress=tty -f Dockerfile -t ${GCP_REGION}-$DOCKER_IMAGE_FQN
